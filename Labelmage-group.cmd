...
mogrify  -font "%_FONT_NAME%" -pointsize %_POINT_SIZE% -background %_BACKGROUND_COLOR% -gravity %_WHICH_END% -annotate %_HORIZONTAL%+%_VERTICAL% "%_MESSAGE%" -append %_FILENAME%
